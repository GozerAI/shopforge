"""LicenseGate — feature entitlement checker for Shopforge.
...
Usage:
    ...
    # Decorator
    @license_gate.require_feature("std.shopforge.enterprise")
...
class LicenseGate:
    ...
    def _refresh_features(self) -> list[str]:
        ...
        try:
            ...
            logger.warning("Vinzy-Engine unreachable; fail-closed — all gated features disabled")
            return []
